...
.run(function ($ionicPlatform, $cordovaFile, $rootScope, $translate, DataManager, Config, GeoLocate) {
  ...
  .config(function ($stateProvider, $urlRouterProvider, $translateProvider, $ionicConfigProvider) {
    ...
    $translateProvider.translations('it', {
      ...
      settings_choose_acc_subtext: "Compatibile con supporti audiodescrittivi installati sul device (TalkBack / VoiceOver). Per attivarli, accedi alla sezione sezione \"Accesso facilitato\" nel menù del dispositivo.",
    ...
    $translateProvider.translations('en', {
      ...
      settings_choose_acc_subtext: "Compatible with descriptive audio tools installed on the device (TalkBack / VoiceOver). To activate them, go to the \"Accessibility\" section in the device menu.",
      settings_choose_standard: "Sighted",
      settings_choose_standard_subtext: "Optimized for users with different visual skills.",
